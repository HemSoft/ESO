...
namespace HemSoft.Eso.Domain
{
    ...
    public partial class GetLastCharacterActivity_Result
    {
        ...
        public Nullable<long> HoursPlayed { get; set; }
        public Nullable<int> UsedBagSlots { get; set; }
        public Nullable<int> UsedBankSlots { get; set; }
        public Nullable<System.DateTime> BlackmithingAvailableAt { get; set; }
        public Nullable<int> BlacksmithingSecondsLeft { get; set; }
        public Nullable<int> BlacksmithingMinutesLeft { get; set; }
        public Nullable<int> BlacksmithingSlotsFree { get; set; }
        public Nullable<int> BlacksmithingSlotsMax { get; set; }
        public Nullable<int> ClothingMinutesLeft { get; set; }
        public Nullable<int> ClothingPercentDone { get; set; }
        public Nullable<int> ClothingSlotsFree { get; set; }
        public Nullable<int> ClothingSlotsMax { get; set; }
        public Nullable<int> WoodworkingMinutesLeft { get; set; }
        public Nullable<int> WoodworkingPercentDone { get; set; }
